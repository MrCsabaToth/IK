...
while arr:
  ...
  if bldg_side.start:
    ...
    if curr_count:
      ...
      height_count_q[:curr_i] + [[bldg_side.height, 1]] + height_count_q[curr_i:]
  ...
  # and update skyline if highest.
    ...
    if height_count_q and height_count_q[curr_i] == bldg_side.height:
      if height_count_q[curr_i][1] == 1:
        height_count_q = height_count_q[:curr_i] + height_count_q[curr_i+1:]
      else:
